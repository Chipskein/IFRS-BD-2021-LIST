...
function convertToNumber($name){
    ...
    $numeros = array(
        ...
        "novecentos" => 900,
        "mil" => 1000,
        "milhao" => $mil == null ? 1000000 : 1000,
        "milhoes" => $mil == null  ? 1000000 : 1000
    );
    $value = 0;
    $name = explode(" ",$name);
